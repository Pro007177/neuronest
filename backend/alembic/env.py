...
# --- Add this section to set the sqlalchemy.url from settings ---
# This ensures Alembic uses the same URL as your app, especially from .env
...
async def run_migrations_online() -> None:
    ...
    # Acquire connection and run migrations within a transaction
    async with connectable.connect() as connection:
         await connection.run_sync(do_run_migrations)
         # If using transaction blocks within migrations:
         # await connection.commit() # Uncomment if needed
